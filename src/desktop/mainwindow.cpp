...
namespace tremotesf
{
          ...
          mTrayIcon(nullptr)
    {
        ...
        QObject::connect(mRpc, &Rpc::torrentFinished, this, [=](const QString& torrent) {
            if (Settings::instance()->notificationOnAddingTorrent()) {
                showNotification(qApp->translate("tremotesf", "Torrent finished"), torrent);
            }
        });
    ...
    void MainWindow::showNotification(const QString& summary, const QString& body)
    {
        ...
        QDBusMessage message(QDBusMessage::createMethodCall("org.freedesktop.Notifications",
                                                            ...
                                                            "org.freedesktop.Notifications",
                                                            "Notify"));
        message.setArguments({"Tremotesf",
                              uint(0),
                              "tremotesf",
                              summary,
                              body,
                              ...
                              -1});
        if (QDBusConnection::sessionBus().call(message).type() == QDBusMessage::ReplyMessage) {
            return;
        }
#endif
    ...
    void MainWindow::setupActions()
    {
        ...
        const QIcon connectIcon(QIcon::fromTheme("network-connect"));
        const QIcon disconnectIcon(QIcon::fromTheme("network-disconnect"));
        if (connectIcon.name() != disconnectIcon.name()) {
            mConnectAction->setIcon(connectIcon);
            mDisconnectAction->setIcon(disconnectIcon);
        }

        mAddTorrentFileAction = mFileMenu->addAction(QIcon::fromTheme("list-add"), qApp->translate("tremotesf", "&Add Torrent File..."));
        ...
        mAddTorrentLinkAction = mFileMenu->addAction(QIcon::fromTheme("insert-link"), qApp->translate("tremotesf", "Add Torrent &Link..."));
        ...
        QAction* quitAction = mFileMenu->addAction(QIcon::fromTheme("application-exit"), qApp->translate("tremotesf", "&Quit"));
#ifdef Q_OS_WIN
        ...
        QAction* torrentPropertiesAction = mTorrentMenu->addAction(QIcon::fromTheme("document-properties"), qApp->translate("tremotesf", "&Properties"));
        ...
        mStartTorrentAction = mTorrentMenu->addAction(QIcon::fromTheme("media-playback-start"), qApp->translate("tremotesf", "&Start"));
        ...
        mStartTorrentNowAction = mTorrentMenu->addAction(QIcon::fromTheme("media-playback-start"), qApp->translate("tremotesf", "Start &Now"));
        ...
        mPauseTorrentAction = mTorrentMenu->addAction(QIcon::fromTheme("media-playback-pause"), qApp->translate("tremotesf", "&Pause"));
        ...
        mRemoveTorrentAction = mTorrentMenu->addAction(QIcon::fromTheme("list-remove"), qApp->translate("tremotesf", "&Remove"));
        QObject::connect(mRemoveTorrentAction, &QAction::triggered, this, &MainWindow::removeSelectedTorrents);

        mTorrentMenu->addSeparator();

        QAction* checkTorrentAction = mTorrentMenu->addAction(QIcon::fromTheme("document-preview"), qApp->translate("tremotesf", "&Check Local Data"));
        ...
        QAction* moveTorrentToTopAction = queueMenu->addAction(QIcon::fromTheme("go-top"), qApp->translate("tremotesf", "Move To &Top"));
        ...
        QAction* moveTorrentUpAction = queueMenu->addAction(QIcon::fromTheme("go-up"), qApp->translate("tremotesf", "Move &Up"));
        ...
        QAction* moveTorrentDownAction = queueMenu->addAction(QIcon::fromTheme("go-down"), qApp->translate("tremotesf", "Move &Down"));
        ...
        QAction* moveTorrentToBottomAction = queueMenu->addAction(QIcon::fromTheme("go-bottom"), qApp->translate("tremotesf", "Move To &Bottom"));
        ...
        mServerSettingsAction = new QAction(QIcon::fromTheme("configure", QIcon::fromTheme("preferences-system")), qApp->translate("tremotesf", "&Server Options"), this);
    ...
    void MainWindow::setupMenuBar()
    {
        ...
        QMenu* editMenu = menuBar()->addMenu(qApp->translate("tremotesf", "&Edit", "Menu"));

        QAction* selectAllAction = editMenu->addAction(QIcon::fromTheme("edit-select-all"), qApp->translate("tremotesf", "&Select All"));
        ...
        QAction* settingsAction = toolsMenu->addAction(QIcon::fromTheme("configure", QIcon::fromTheme("preferences-system")), qApp->translate("tremotesf", "&Options"));
        ...
        QAction* aboutAction = helpMenu->addAction(QIcon::fromTheme("help-about"), qApp->translate("tremotesf", "&About"));
